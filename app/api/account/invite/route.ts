...
import { getUser, listInvitees, setInvitedBy } from '../../../../lib/users';
...
export async function GET(req: NextRequest) {
  try {
    ...
    const invitees = me?.invite_code ? await listInvitees(me.invite_code) : [];
...
export async function POST(req: NextRequest) {
  try {
    ...
    const updated = await setInvitedBy(phone, code);
